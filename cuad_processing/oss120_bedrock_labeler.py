...
def main():
    """Label contracts using AWS Bedrock OSS120 model.
    
    All paths and settings are hardcoded - no arguments needed.
    Simply run: python oss120_bedrock_labeler.py
    """
    import os
    ...
    threads = 200  # Parallel threads
    no_resume = False  # Enable resume by default
    parallel = True  # Enable parallel processing
    use_langgraph = False  # Use standard approach by default
